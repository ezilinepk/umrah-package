<!-- Modal-->
<div class="modal fade" id="detetePaper" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('paper.destroy') }}" >
                @csrf
                <div class="modal-body">
                    <input type="hidden" id="del_paper_id" name="del_paper_id">
                    <p>Are You Sure you wan't to Delete this Paper?</p>
                </div>
