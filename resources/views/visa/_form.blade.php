<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="number" class="form-control @error('visa_price') is-invalid state-invalid @enderror" name="visa_price" id="visa_price" placeholder="Enter Visa Price in Riyals..." required>
        ...
        <div class="col-md-4">
            ...
            <input type="date" class="form-control @error('visa_valid_date') is-invalid state-invalid @enderror" name="visa_valid_date" id="visa_valid_date" required>
        ...
        <div class="col-md-4">
            ...
            <input type="date" class="form-control @error('visa_exp_date') is-invalid state-invalid @enderror" name="visa_exp_date" id="visa_exp_date" required>
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('visa_country') is-invalid state-invalid @enderror" name="visa_country" id="visa_country" placeholder="Enter Visa Country..." required>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('visa_type') is-invalid state-invalid @enderror" name="visa_type" id="visa_type" placeholder="Enter Type of Visa..." required>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('visa_place_of_issue') is-invalid state-invalid @enderror" name="visa_place_of_issue" id="visa_place_of_issue" placeholder="Enter Place of Issue..." required>
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="number" class="form-control @error('visa_price_with_transport') is-invalid state-invalid @enderror" name="visa_price_with_transport" id="visa_price_with_transport" placeholder="Enter Visa Price with Transport in Riyals..." required>
