...
@section('pageName',__('Create Permission'))
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Create Permission</h3><small>All fields marked with asterisks(*) are required.</small>
            </div>
        </div>
        <form method="post" action="{{ route('permission.store') }}" class="needs-validation" novalidate>
            @csrf
            <div class="card-body">
                <!-- Include Form -->
