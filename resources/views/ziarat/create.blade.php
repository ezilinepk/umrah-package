...
@section('pageName',__('Add ziarat Detail'))
...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <form method="post" action="{{ route('ziarat.store') }}" class="needs-validation" novalidate enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <!-- Include Form -->
                @include('ziarat._form')
            </div>
